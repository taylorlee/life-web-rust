...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            "__extjs_d4c220120981d17feaa255724c6f6dfcbad3b3b8": function($0) {
                Module.STDWEB.from_js($0, (function(){return {"loop" : function (){}};})());
            },
            "__extjs_8d809b85e1e67e4925e7343c28e1ffc6ba92a030": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){var bind = ($1); var callback = ($2); bind.loop = callback ;})());
            },
            "__extjs_7dc18ec6d7ef35c7c4cc2dfc114c4bf4186e0c7d": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){var bind = ($1); setTimeout (bind.loop);})());
            },
            ...
            "__extjs_9867aadf0bcb42b3f3d7476a1d3fa364c97690ea": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){var handle = ($1); clearInterval (handle.interval_id); handle.callback.drop ();})());
            },
            ...
            "__extjs_7ccd6a44906d9a33ff325bb0c161fa6ac56496c3": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){var callback = ($1); var action = function (){callback ();}; var delay = ($2); return {interval_id : setInterval (action , delay), callback : callback ,};})());
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'life'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'life':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" && typeof process === "object" ) {
        ...
        const wasm_path = path.join( __dirname, "life.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "life.wasm" )
